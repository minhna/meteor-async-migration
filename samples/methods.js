...
import Codes, { NotACollection } from "./collections";
import { Profiles, NamedCodes } from "./collections";
...
//       return {
//         status: "success",
//         message: "Successfully invalidated sms codes",
//       };
//     } catch (e) {
//       return {
//         status: "failed",
...
//       return {
//         status: "failed",
//         message: `Error when retrieving code: ${e.message}`,
//       };
//     }
//   },
// });
...
export const someFunction = () => {
  ...
  const b = NamedCodes.findOne({});
  const c = NotACollection.findOne();
  Codes.update({ a: 1 }, {});
